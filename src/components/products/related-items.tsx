...
export function RelatedItems() {
  ...
  return (
    <div className="pb-[96px] pt-[48px]">
      <div className="pb-[16px] border-b ">
        <h1 className="h4 text-gray-900 ">Related Items</h1>
      </div>
                ...
                <div className="absolute bottom-0 left-6 right-6 ">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <h5 className="h6 text-[#02C406]">Save 30%</h5>
                    </div>
                    <Link
                      href="/addcart"
                      className="flex items-center border rounded-xl w-fit px-3 py-[2px] gap-x-2 border-[#10B404]"
                    >
